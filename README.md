# 🥗 Sistem Pemantauan Kualitas Makanan MBG
...
1. Clone repositori ini:
   ```bash
   git clone https://github.com/Charboros/ResponsiKB_Shift-A_H1D024085.git
   ```
2. Instal dependensi:
   ```bash
...
## 📖 Dokumentasi Detail
- [Panduan Sistem Logika Fuzzy](README_FUZZY.md)
- [Panduan Sistem Pakar](README_EXPERT.md)
